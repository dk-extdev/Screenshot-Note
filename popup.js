...
//Send page scroll event function
//file: to page.js
...
//file: to js/notes.js
document.getElementById('current_screen').onclick=function(){
	chrome.tabs.getSelected(null, function(tab) {
		if (testURLMatches(tab.url)) {
			var loaded = false;
			//run page.js of extension folder
...
//Run when click note button.
//file: to js/notes.js
document.getElementById('current_note').onclick=function(){
	chrome.tabs.getSelected(null, function(tab) {
		//send request to content script (note.js) with current tab id.
