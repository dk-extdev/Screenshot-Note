...
if (!window.hasScreenCapturePage) {
	...
	//Chrome runtime listener from popup.js
...
function getPositions(callback) {
    var body = document.body,
        ...
        fullWidth = max(widths),//get max width
        fullHeight = max(heights),//get max height
    ...
    while (yPos > -yDelta) {//get position xposition, yposition
        xPos = 0;
	...
	//Send capture request to popup.js by using set timeout function.
    (function processArrangements() {
        ...
        window.setTimeout(function() {
			...
			//send request capture event to popup.js
